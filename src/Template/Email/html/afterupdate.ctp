 							...
 							<td align="center">
 								...
 								<table width="100%" align="center" cellspacing="0" cellpadding="0" border="0" class="full-width" >
 									<tbody>
 										...
 										<tr>
 											<td class="font_fix" style="font-size:16px; mso-line-height-rule:exactly; line-height:20px; color:#555555; font-weight:bold; font-family: 'Montserrat', sans-serif;" align="center"><strong style="font-size:20px; text-transform:uppercase;">Votre mise à jour a été validée</strong><br />
 											sur Marseille Green, le guide des meilleurs spots écolos et bio sur Marseille</td>
 										</tr>
 										<tr>
 										...
 										<tr >
 											<td style="font-size:14px; mso-line-height-rule:exactly; line-height:18px; color:#95a5a6; font-weight:normal; font-family: Arial, Helvetica, sans-serif;" align="center">
 												Nous avons bien pris en compte le changement de vos informations de connexion.
 												Vous pouvez maintenant vous connecter avec vos nouveaux identifiants sur votre <strong>espace personnel</strong></td>
 										</tr>
 										<tr>
