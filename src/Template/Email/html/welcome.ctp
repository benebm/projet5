 							...
 							<td align="center">
 								...
 								<table width="100%" align="center" cellspacing="0" cellpadding="0" border="0" class="full-width" >
 									<tbody>
 										...
 										<tr>
 											<td class="font_fix" style="font-size:16px; mso-line-height-rule:exactly; line-height:20px; color:#555555; font-weight:bold; font-family: 'Montserrat', sans-serif;" align="center"><strong style="font-size:20px; text-transform:uppercase;">Bienvenue chez Marseille Green</strong><br />
 											le guide des meilleurs spots écolos et bio sur Marseille</td>
 										</tr>
 										<tr>
 											<td height="20" style="line-height:20px; " ></td>
 										</tr>
 										<tr >
 											<td style="font-size:14px; mso-line-height-rule:exactly; line-height:18px; color:#95a5a6; font-weight:normal; font-family: Arial, Helvetica, sans-serif;" align="center">Bravo! Vous faites maintenant partie de la communauté Marseille Green, et vous pouvez dès maintenant participer en <strong>évaluant les spots que vous avez déjà testés</strong> afin de contribuer à la qualité de l'expérience Marseille Green. Vous pouvez aussi consulter votre <strong>carnet d'appréciations</strong> qui regroupe l'ensemble de vos avis! </td>
 										</tr>
 										<tr>
