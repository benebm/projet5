...
<title>Un message pour vous de Marseille Green</title>
    ...
    <td>
    	<!-- Start Space -->
			<!--<table width="100%" bgcolor="#e8e8e8" cellspacing="0" cellpadding="0" border="0" class="full-width" >
				<tbody>
					<tr>
						<td height="28" align="center" style="font-family: Arial, Helvetica, sans-serif;font-size:11px; font-weight:normal; color:#7f8c8d;"><a href="#" style="color:#00c1f1; text-decoration:underline !important;">Cliquez ici</a> si vous n'arrivez pas à lire l'email.</td>
					</tr>
				</tbody>
			</table>-->
		<!-- End Space -->
																		...
																		<td valign="top" align="center">
																			...
																			<table align="center" cellspacing="0" cellpadding="0" border="0" class="full-width" width="100%">
																				<tbody>
																					...
																					<!--<tr>
																						<td class="font_fix" style="font-size:14px; height:20px; color:#ffffff; font-weight:normal; font-family: 'Montserrat', sans-serif;" align="center">Contactez nous</td>
																					</tr>-->
																					<tr>
													...
													<tr>	
														<td align="center">														
															...
															<table width="550" align="center" cellspacing="0" cellpadding="0" border="0" class="content-width">
																<tbody>
																	<tr>
																		<td  align="center" valign="middle" style="font-family: Arial, Helvetica, sans-serif;font-size:11px; font-weight:normal; color:#cccccc; padding-top:10px; padding-bottom:10px"><strong>Copyright © 2018 Benedicte for Openclassroom</strong><!--<br />
