...
<main>
			...
			<div class="row">
				...
				<div class="col-md-6 nopadding">
					<div class="features-content">
						...
						<p>Changer Marseille, cela ne se fera pas en un jour. Mais nous sommes passionnés par ce que nous faisons et nous croyons vraiment que nos actions peuvent avoir un impact sur notre ville.</p>
		...
		<div class="container margin_60">
			...
			<div class="main_title">
				<h2>Nos <span>Green </span>addicts témoignent</h2>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="review_strip">
						<img src="<?= $this->Url->image('avatar1.jpg') ?>" alt="Image" class="img-circle">
						<h4>Jhon Doe</h4>
						<p>
				...
				<div class="col-md-6">
					<div class="review_strip">
						<img src="<?= $this->Url->image('avatar2.jpg') ?>" alt="Image" class="img-circle">
						<h4>Frank Rosso</h4>
						<p>
							"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed a lorem quis neque interdum consequat ut sed sem. Duis quis tempor nunc. Interdum et malesuada fames ac ante ipsum primis in faucibus."
						</p>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="review_strip">
						<img src="<?= $this->Url->image('avatar3.jpg') ?>" alt="Image" class="img-circle">
						<h4>Marc twain</h4>
						<p>
							"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed a lorem quis neque interdum consequat ut sed sem. Duis quis tempor nunc. Interdum et malesuada fames ac ante ipsum primis in faucibus."
						</p>
