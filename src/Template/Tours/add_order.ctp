				...
				<div class="col-md-8">
							...
							<tr>
								<td>
									<div class="thumb_cart">
										<?php echo $this->Html->image($tour->image, ['alt' => 'Image']); ?>
								...
								<td>
									<div class="numbers-row">
										<input type="text" value="<?= $_POST['guests'] ?>" id="quantity_2" class="qty2 form-control" name="quantity_2">
									</div>
								</td>
								<td>
									<?= $_POST['day'] . '<br />' .  $_POST['time'] . '<br />' .  $_POST['duration'] ?>
								</td>
								<td>
                    ...
                    <span>No</span>
							...
							<tr>
								...
								<td>
									RDV à l'adresse de votre choix <strong>+$34*</strong>
								</td>
								<td>
									<label class="switch-light switch-ios pull-right">
                    ...
                    <span>No</span>
							...
							<tr>
								...
								<td>
									Panier d'accueil <strong>+$24</strong>
								</td>
								<td>
									<label class="switch-light switch-ios pull-right">
					...
					<div class="add_bottom_15"><small>* Prix par personne</small>
					</div>
				</div>
				<!-- End col-md-8 -->
